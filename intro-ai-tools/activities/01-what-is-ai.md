...
| **The Intelligent Piece of Paper** | `show→assist` | Tic-tac-toe vs. a sheet of if/then rules — it "wins" without thinking. Stretch: write the rule sheet yourself. | [ISTE](https://iste.org/blog/3-unplugged-activities-for-teaching-about-ai) |
...
| **Elements of AI Ch. 1 pre-work** | `solo→assist` | The recommended free text (University of Helsinki + MinnaLearn, no affiliation); self-paced definitions + reflection, discussed in class. | [elementsofai.com](https://www.elementsofai.com/) |
